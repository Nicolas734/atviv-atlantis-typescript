...
const CadastrarHospedagem: React.FC = () =>{
    ...
    const acomodacoes = [
        { acomodacao: 'Aquário Casal Simples'},
        { acomodacao: 'Aquário Família Simples'},
        { acomodacao: 'Mar Família Mais'},
        { acomodacao: 'Oceano Família Super'},
        { acomodacao: 'Aquário Solteiro Simples'},
        { acomodacao: 'Aquário Solteiro Mais'}
    ]
